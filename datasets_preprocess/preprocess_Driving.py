...
def get_parser():
    ...
    parser.add_argument("--output_dir", type=str, default=f"{data_path}/SceneFlow/Driving_proc")
    parser.add_argument("--data_dir", type=str, default=f"{data_path}/SceneFlow/Driving")
