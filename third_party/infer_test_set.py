    ...
    for image_path in tqdm(sorted(os.listdir(data_dir))[int(args.a):int(args.b)]):
      ...
      if image_path.split('.')[-1]=='jpg' or image_path.split('.')[-1]=='png': 
        if args.dataset_name == "bonn":
          ...
          if not os.path.exists(data_dir.replace('rgb_110', 'rgb_110_depth_prediction_moge')):
            os.makedirs(data_dir.replace('rgb_110', 'rgb_110_depth_prediction_moge'))
          ...
          if not os.path.exists(data_dir.replace('rgb_50', 'rgb_50_depth_prediction_moge')):
            os.makedirs(data_dir.replace('rgb_50', 'rgb_50_depth_prediction_moge'))
