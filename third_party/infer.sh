...
# CUDA_VISIBLE_DEVICES=1 python infer_test_set.py --a=0 --b=10000 --dataset_name=davis &\
# CUDA_VISIBLE_DEVICES=1 python infer_test_set.py --a=0 --b=10000 --dataset_name=sintel &\
